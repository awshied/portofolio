    ...
    <section id="hero" className="relative overflow-hidden">
      ...
      <div className="hero-layout flex flex-col lg:flex-row items-center justify-between lg:gap-10">
        ...
        <figure className="w-full bg-amber-50 lg:w-1/2 lg:translate-y-none flex justify-center items-center">
          <div className="absolute top-90 md:top-140 lg:top-30 xl:top-20 h-[300px] md:h-[460px] lg:h-[420px] w-[180px] md:w-[300px] lg:w-[280px] bg-blue-150 flex justify-center items-center rounded-full overflow-hidden border-2 border-purple-500">
            <img
